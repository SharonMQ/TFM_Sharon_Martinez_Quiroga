...
resultdir<- file.path("~/Documentos/6to cuatrimestre/TFM/Workflows/Workflow/Datos_parte1", "Top_genes_filt_parameters.csv")
...
```{r}
resultdir<- file.path("~/Documentos/6to cuatrimestre/TFM/Workflows/Workflow/Datos_parte1", "Top_genes_log2FPKG.csv")
...
```{r}
resultdir<- file.path("~/Documentos/6to cuatrimestre/TFM/Workflows/Workflow/Datos_parte1", "transcriptoma_logFPKM.csv")
