...
```{r}
dir.create("Datos_patologicos")
exportClass(datos_COAD_pat, dir = "Datos_patologicos", fmt = "csv", ext = ".csv")
```

Y también se guardan los normales:

```{r}
dir.create("Datos_normales")
exportClass(datos_COAD_norm, dir = "Datos_normales", fmt = "csv", ext = ".csv")
